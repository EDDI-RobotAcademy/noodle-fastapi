...
async def requestAiResultToDbTestPoint(aiToDbTestPointRequestForm:AiToDbTestPointRequestForm,
    ...
    success = await aiToDbTestPointService.requestAiResultToDbTestPoint(aiToDbTestPointRequestForm.toAiToDbTestPointRequest())
